...
| M | **đã merge main `d64133d`** (owner "merge, chạy tiếp cho tới khi xong" 17/09/2026, PR #4), **đã đóng gói 1.3.0 alpha** (gate 714/714, SHA-256 `C844186E…`, `Z:\My Drive\RELEASE\ALPHA TEST`, chưa ai nghe trên rig) — nhánh `feat/lane-m-active-soundcheck`, 43 commit, 12 task SDD, final review 0 finding mở; 15 mục Q chốt tạm (Q24) chờ nghe rig để lật lại | 2026-09-17 |
