...
RELEASE: installer\release-alpha.ps1 -> 1.1.3 published to Z:\My Drive\RELEASE\ALPHA TEST (gate 454/454, NSIS 26847229 bytes, 1.1.0 pruned; first run failed on missing gitignored installer/vendor/vc_redist.x64.exe in this worktree — copied from the main checkout after verifying the pinned SHA CC0FF0EB…, no download). SHA-256 0B09D7FDBF71B39C31EF9114800CDF10523273E4C817DC68E15EC5AEB7376E26. Drop TESTER-NOTES.md got a v1.1.3 section; repo installer/TESTER-NOTES.md header, 1.1.3 note build line, KY-THUAT top-matter and plan LANE R status updated.
